...
import { DescribeRegionsCallback, generateMockRegions } from '../utilities/aws-mock-utilities';
...
describe('this module lists all regions', function() {
  ...
  it('should return an empty list when there\'s no "Regions" key', async function() {
    awsMock.mock(ec2Service, describeRegionMethodString, function(callback: DescribeRegionsCallback) {
      callback(null, {});
    });
